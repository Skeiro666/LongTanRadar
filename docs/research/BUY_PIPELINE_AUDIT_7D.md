...
| min_leader_score | 0.1 | 70.0% | 42 | 60 |
| min_ml_prediction | 0.003 | 100.0% | 60 | 60 |
| min_profit_score | 0.15 | 100.0% | 60 | 60 |
| min_event_score | 0.08 | 100.0% | 60 | 60 |
| min_news_score | 0.12 | 100.0% | 60 | 60 |
...
- **direct_reason:** `ACTION_NOT_SMALL_POSITION:WAIT_FOR_CONFIRMATION`
...
- evidence: `{'APPROVED': 4, 'ACTION_NOT_SMALL_POSITION:WAIT_FOR_CONFIRMATION': 1}`

### None: ML prediction fails research_gate threshold on majority of candidates
- id: `ML_HARD_THRESHOLD`
- evidence: `min_ml_prediction fail_rate=100.0%, ml_dist={'n': 0}`
